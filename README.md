...
In dem Gehäuse war zum Glück noch ausreichend Platz, um dort einen WEMOS D1, einen kleinen Step-UP Regler (5Vdc auf 9Vdc) und eine Interface Elektronik (Pegelanpassung) - mit 2 Tastern (TEST & RESET) unterzubringen.
